...
``` {r scatterplot1, fig.path = '{{ site.baseurl }}/figures/'}
plot(x, y, 
...
``` {r scatterplot2, fig.path = '{{ site.baseurl }}/figures/'}
...
``` {r scatterplot3, fig.path = '{{ site.baseurl }}/figures/'}
...
``` {r scatterplot4, fig.path = '{{ site.baseurl }}/figures/'}
plot(x, y, ylim = c(-3,3), xlim = c(-3,3))
my_lin_model <- lm(y ~ x) 
...
``` {r histogram, fig.path = '{{ site.baseurl }}/figures/'}
x <- rnorm (1000)
par(mfrow=c(1,2))
...
``` {r QQplot1, fig.path = '{{ site.baseurl }}/figures/'}
...
``` {r QQplot2, fig.path = '{{ site.baseurl }}/figures/'}
x1 <- rnorm(100, mean = 0, sd = 1) 
...
``` {r lineplot1, fig.path = '{{ site.baseurl }}/figures/'}
...
``` {r density1, fig.path = '{{ site.baseurl }}/figures/'}
...
``` {r boxplot1, fig.path = '{{ site.baseurl }}/figures/'}
...
``` {r boxplot2, fig.path = '{{ site.baseurl }}/figures/'}
...
``` {r pie1, fig.path = '{{ site.baseurl }}/figures/'}
...
``` {r barplot1, fig.path = '{{ site.baseurl }}/figures/'}
...
``` {r pie2, fig.path = '{{ site.baseurl }}/figures/'}
...
``` {r barplot2, fig.path = '{{ site.baseurl }}/figures/'}
...
``` {r barplot3, fig.path = '{{ site.baseurl }}/figures/'}
barplot(my_peak_percent ,
        ylab = "Percentage of Peaks in Feature", 
        main = "Peaks in Gene Features", 
        legend.text = my_peak_nums[["GeneFeature"]], 
...
``` {r barplot4, fig.path = '{{ site.baseurl }}/figures/'}
...
``` {r subplot1, fig.path = '{{ site.baseurl }}/figures/'}
...
``` {r subplot2, fig.path = '{{ site.baseurl }}/figures/'}
...
``` {r save, fig.path = '{{ site.baseurl }}/figures/'}
png("{{ site.baseurl }}/figures/test_figure.png", height = 10, width = 10, unit = "in", res = 300)
...
[files/experiment1_control.txt](files/experiment1_control.txt) -- Expression levels for control in experiment 1 
[files/experiment1_drug.txt](files/experiment1_drug.txt) -- Expression levels for drug A in experiment 1 
[files/experiment2_control.txt](files/experiment2_control.txt) -- Expression levels for control in experiment 2
[files/experiment2_drug.txt](files/experiment2_drug.txt) -- Expression levels for drug A in experiment 2 
