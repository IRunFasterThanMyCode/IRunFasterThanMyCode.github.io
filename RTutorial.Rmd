...
``` {r scatterplot1, fig.path = 'figures/'}
plot(x, y, 
...
``` {r scatterplot2, fig.path = 'figures/'}
...
``` {r scatterplot3, fig.path = 'figures/'}
...
``` {r scatterplot4, fig.path = 'figures/'}
plot(x, y, ylim = c(-3,3), xlim = c(-3,3))
my_lin_model <- lm(y ~ x) 
