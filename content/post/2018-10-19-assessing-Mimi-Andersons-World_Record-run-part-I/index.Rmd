---
title: "Strava Data Mining: Assessing Mimi Anderson's World Record Run Across the USA"
author: samrobson
draft: false
date: 2018-10-19
image:
  caption: 
summary: Analysis of data from Strava to assess the validity of data for a World Record Run across the USA
categories: [Blog, Data Science, Running, R]
tags: [R, Data Science, ultra, ultrarunning, GWR, Mimi, Anderson, Guinness, World, Record, USA, transcon]
output: 
  blogdown::html_page:
...
knitr::opts_chunk$set(echo = TRUE, message = FALSE, error = FALSE, eval = TRUE, results = "hide", fig.height = 10, fig.width = 10, dpi = 300, collapse = TRUE, cache = TRUE)
options(scipen = 999)
load("mimi.Rdata")
```
...
``` {r mimis_time_diff, results = "asis"}
...
``` {r sandras_time_diff, results = "asis"}
...
``` {r mimi_cadence_over_time, height = 10, width = 6}
...
``` {r sandra_cadence_over_time, height = 6, width = 6}
...
``` {r mimi_cadence_over_time_smooth, height = 10, width = 6}
...
``` {r my_cadence_over_time_smooth, height = 6, width = 6}
...
``` {r final_digit_dist, fig.height = 10, fig.width = 6}
